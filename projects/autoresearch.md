...
- [nanochat](nanochat.md) — 被研究的模型
- [SkyPilot 分布式扩展](../community/scaling-autoresearch.md) — SkyPilot 分布式协作层
- [CPU 版实现](../community/auto-architecture-cpu.md) — [FeSens/auto-arch-tournament](https://github.com/FeSens/auto-arch-tournament)
- [Karpathy 的 AI Agent 编程准则](karpathy-skills.md) — Karpathy Skills
